...
const Footer = () => {
    return (
        ...
        <aside className="font-bold mt-10">
          ...
          <p className="md:text-2xl">RHM Industries Ltd. </p>
          <p className="mx-5 md:mx-10 md:text-xl">Art <span className="text-red-600">& Craft</span></p>
          <aside className="items-center  flex justify-around ">
